 ...
 * @param bptAmountOut - the amount of BPT to be minted
 */
StablePoolEncoder.joinAllTokensInForExactBptOut = (bptAmountOut) => abi.defaultAbiCoder.encode(['uint256', 'uint256'], [exports.StablePoolJoinKind.ALL_TOKENS_IN_FOR_EXACT_BPT_OUT, bptAmountOut]);
/**
 ...
 */
StablePoolEncoder.exitExactBptInForTokensOut = (bptAmountIn) => abi.defaultAbiCoder.encode(['uint256', 'uint256'], [exports.StablePoolExitKind.EXACT_BPT_IN_FOR_ALL_TOKENS_OUT, bptAmountIn]);
...
})(exports.GaugeType || (exports.GaugeType = {}));
