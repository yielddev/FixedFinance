...
contract RcurTestData is Test {
    ...
    function _print(RcurData memory _data) internal {
        ...
        emit log_named_uint("currentAnnualInterest", _data.expected.currentAnnualInterest);
