...
interface IStakelessGauge {
    ...
    /**
     * @notice Configures a checkpointer role for the stakeless gauge
     * @param newCheckpointer Address of the new checkpointer
     */
    ...
    /**
     * @notice Gets the address of the checkpointer
     */
